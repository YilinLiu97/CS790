...
def parse_args():
    ...
    parser.add_argument('--display_epoch', default=50, type=int, help='node rank for distributed training')
    ...
    parser.add_argument('--input_dir', default='./data/3.jpg', type=str, help='full AE or decoder only')
