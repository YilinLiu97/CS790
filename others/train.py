...
from model.image_processor import store_img, restore_img, store_fig, draw_stats, draw_l1
...
def main():
    ...
    for i in range(args.num_epoch):
        if i % args.display_epoch == 0 or i == args.num_epoch - 1:
            ...
            attn = model.attn
            draw_stats(attn, out, args.patch_size, origin_shape, args.img_dir + "{}_epoch_attn.jpg".format(i),
                       args.img_dir + "{}_epoch_map.jpg".format(i))
            draw_l1(out, y, args.img_dir + "{}_l1.jpg".format(i))
