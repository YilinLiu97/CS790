...
from model.trainsformer import ViTransformerWrapper, TransformerWrapper, Encoder, Decoder
...
class GeneratorDecoder(nn.Module):
    ...
    def forward(self, x, seq):
        ...
        out, attn = self.decoder(seq, return_attn=True)
